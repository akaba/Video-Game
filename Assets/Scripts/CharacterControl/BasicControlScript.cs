...
public class BasicControlScript : MonoBehaviour
{
    ...
    void Update() {
        ...
        //1.) SomeDude_NoRootMotion – disable turn animation by NOT passing turn input to the Animator (only turning programmatically) 10 pts
        //anim.SetFloat("velx", inputTurn);  << ---Disable sending the rotation input to the animator. 23:36 AND 35:00 ON VIDEO
